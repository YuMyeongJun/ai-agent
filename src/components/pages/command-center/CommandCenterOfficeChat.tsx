...
export interface ICommandCenterOfficeChatProps {
  messages: IChatMessage[]
  error: string | null
  isRunning: boolean
}

export const CommandCenterOfficeChat = ({
  messages,
  error,
  isRunning,
}: ICommandCenterOfficeChatProps) => {
      ...
      <div className="office-chat__messages" ref={scrollRef}>
        <AnimatePresence initial={false}>
          {messages.length === 0 && !error && (
            <p className="office-chat__empty">
